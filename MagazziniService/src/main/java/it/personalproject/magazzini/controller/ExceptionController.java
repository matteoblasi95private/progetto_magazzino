...
public class ExceptionController {
    ...
    @ExceptionHandler(MagazzinoNotFoundException.class)
    public ProblemDetail handleResourceNotFoundException(MagazzinoNotFoundException e, HttpServletRequest req) {
    ...
    private ProblemDetail buildProblemDetail(Exception e, String errorId, HttpServletRequest req, HttpStatus status) {
        ...
        pd.setTitle("Internal Server Error Magazzini Service");

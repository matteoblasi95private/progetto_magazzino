...
import it.personalproject.prodotti.controller.ExceptionController;
import it.personalproject.prodotti.exceptions.ProdottoNotFoundException;
...
public class ExceptionController {
    ...
    @ExceptionHandler(SpedizioneNotFoundException.class)
    public ProblemDetail handleResourceNotFoundException(SpedizioneNotFoundException e, HttpServletRequest req) {
    ...
    private ProblemDetail buildProblemDetail(Exception e, String errorId, HttpServletRequest req, HttpStatus status) {
        ...
        pd.setTitle("Internal Server Error Spedizioni Service");

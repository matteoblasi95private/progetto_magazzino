...
public class ExceptionController {
    ...
    public ProblemDetail handleResourceNotFoundException(StockNotFoundException e, HttpServletRequest req) {
    ...
    private ProblemDetail buildProblemDetail(Exception e, String errorId, HttpServletRequest req, HttpStatus status) {
        ...
        pd.setTitle("Internal Server Error Giacenze Service");

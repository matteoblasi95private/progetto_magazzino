...
public class ExceptionController {
    ...
    public ProblemDetail handleResourceNotFoundException(ProdottoNotFoundException e, HttpServletRequest req) {
    ...
    private ProblemDetail buildProblemDetail(Exception e, String errorId, HttpServletRequest req, HttpStatus status) {
        ...
        pd.setTitle("Internal Server Error Prodotti Service");
